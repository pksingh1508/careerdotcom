...
export function SingleTestimonial({
  ...
  return (
    ...
    >
      ...
      >
        {/* Background gradient */}
        <div className="absolute inset-0 bg-linear-to-br from-blue-50/30 to-purple-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          <div>
            <div className="relative w-full h-96">
              ...
              {data.user_image ? (
                ...
                <div className="w-full h-full bg-linear-to-br from-blue-400 to-purple-500 flex items-center justify-center rounded-2xl">
        ...
        <div className="absolute top-0 right-0 w-20 h-20 bg-linear-to-br from-amber-400/20 to-orange-400/20 rounded-full transform translate-x-8 -translate-y-8 group-hover:scale-150 transition-transform duration-500 opacity-0 group-hover:opacity-100" />
      </Card>
